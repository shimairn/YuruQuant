    ...
    def test_summarize_backtest_run_and_trade_diagnostics(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with signals_path.open('w', newline='', encoding='utf-8') as handle:
                ...
                writer.writerow(['r', 'BACKTEST', '2026-01-01 10:00:00', 'DCE.P', 'DCE.p2605', 'close_long', 'hourly ma stop', '1', '1', '115', 'hourly_ma_stop', 'c1', '', '', '', 'ascended', '3.2'])
                ...
                writer.writerow(['r', 'BACKTEST', '2026-01-03 10:00:00', 'DCE.P', 'DCE.p2605', 'close_long', 'protected stop', '1', '1', '199', 'protected_stop', 'c3', '', '', '', 'ascended', '2.7'])
            ...
            with executions_path.open('w', newline='', encoding='utf-8') as handle:
                ...
                writer.writerow(['r', 'BACKTEST', '2026-01-02 09:00:00', '2026-01-02 09:05:00', 'DCE.P', 'DCE.p2605', 'c2', 'buy', '100', '100', 'normal', '0', '0.0', 'e3', 'buy:open_long', '1', '1', 'submitted', '2026-01-02T09:05:00'])
                ...
                writer.writerow(['r', 'BACKTEST', '2026-01-03 09:00:00', '2026-01-03 09:05:00', 'DCE.P', 'DCE.p2605', 'c3', 'buy', '200', '200', 'normal', '0', '0.0', 'e5', 'buy:open_long', '1', '1', 'submitted', '2026-01-03T09:05:00'])
                writer.writerow(['r', 'BACKTEST', '2026-01-03 10:00:00', '2026-01-03 10:05:00', 'DCE.P', 'DCE.p2605', 'c3', 'close_long', '199', '198', 'normal', '1', '0.5', 'e6', 'close_long', '0', '1', 'submitted', '2026-01-03T10:05:00'])
            ...
            self.assertEqual(summary['hourly_ma_stop_count'], 1)
            self.assertEqual(summary['ascended_exit_count'], 2)
            self.assertEqual(summary['ascended_protected_stop_count'], 1)
            self.assertEqual(summary['ascended_hourly_ma_stop_count'], 1)
            ...
            self.assertAlmostEqual(summary['session_restart_gap_overshoot_ratio'], 40.0 / 110.0)
            self.assertAlmostEqual(summary['hard_stop_overshoot_avg'], 40.0)
            self.assertAlmostEqual(summary['hard_stop_overshoot_max'], 40.0)
            self.assertAlmostEqual(summary['protected_stop_overshoot_avg'], 70.0)
            self.assertAlmostEqual(summary['protected_stop_overshoot_max'], 70.0)
            self.assertAlmostEqual(summary['start_equity'], 500000.0)
            ...
            self.assertAlmostEqual(by_campaign['c3']['theoretical_stop_price'], 205.0)
            self.assertAlmostEqual(by_campaign['c3']['overshoot_pnl'], 70.0)
            ...
            self.assertEqual(by_campaign['c3']['phase_at_exit'], 'ascended')
