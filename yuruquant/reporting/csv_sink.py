...
from yuruquant.core.models import EntrySignal, ExitSignal, RuntimeState, Signal
...
class CsvReportSink:
    ...
    def record_executions(self, runtime: RuntimeState, mode: str, run_id: str, csymbol: str, symbol: str, created_at: object, results: list[object]) -> None:
    ...
    def record_portfolio_day(self, runtime: RuntimeState, mode: str, run_id: str, trade_day: str) -> None:
        ...
        if path is None or runtime.last_portfolio_report_date == trade_day:
            return
        ...
        runtime.last_portfolio_report_date = trade_day
